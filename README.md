...
When I'm not coding, you can find me experimenting with photography, diving into creative projects, or expanding my knowledge in digital arts and AI.
## 🛠 Skills

**Languages:** JavaScript (ES6+), HTML5, CSS3, PHP, SQL, C

**Frameworks and libraries:** ReactJS, Redux, GSAP, Three.js, TailwindCSS, Bootstrap

**Design Tools:** Figma, Adobe Photoshop, Illustrator, InDesign

**Version Control:** Git, GitHub, GitLab

**Development Tools:** Visual Studio Code, Webpack, npm, Composer

**Other:** WordPress, ACF, Lenis, GSAP, Canvas, p5.js
## Tech Stack

**Frontend:** ReactJS, Redux, TailwindCSS, GSAP, Three.js, Next.js
